...
python ../sentence_classification.py --cell_type="PLSTM" --learning_rate=1e-6 --n_cell=16 --n_epoch=400 --n_layer=2 --dropout_keep_prob=0.7 --exp_name="exp1";
...
python ../sentence_classification.py --cell_type="PLSTM" --learning_rate=1e-6 --n_cell=64 --n_epoch=400 --n_layer=2 --dropout_keep_prob=0.7 --exp_name="exp1";
