...
python ../sentence_classification.py --cell_type="LSTM" --learning_rate=1e-6 --n_layer=6 --n_cell=32 --n_epoch=400 --dropout_keep_prob=0.7 --exp_name="add_exp01_6layer";
...
python ../sentence_classification.py --cell_type="PLSTM" --learning_rate=1e-6 --n_layer=6 --n_cell=32 --n_epoch=400 --dropout_keep_prob=0.7 --exp_name="add_exp01_6layer";
